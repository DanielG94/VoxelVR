...
/// </example>
[ExecuteInEditMode]
public class Colorhistory_RadialMenu : MonoBehaviour
{
	...
	// CUSTOMIZED: Max amount of buttons
	public int maxButtonCount = 6;
    ...
    [Tooltip("The background colour of the buttons, default is white.")] // CUSTOMIZED: List of colors
    ...
    protected virtual void Awake()
    {
        ...
        {
			AddButton(new RadialMenuButton(), Color.white);
			if (!isShown)
            {
    ...
    protected virtual void Update()
    {
		...
		if(currentHover != -1) {
			//Debug.Log("Test: " + currentPress + " " + buttonColors[currentPress-1]);
			Colorpicker.cubeColor = buttonColors[currentHover];
		}
    }
