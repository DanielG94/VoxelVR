...
public class Colorpicker : MonoBehaviour {
	...
	private void DoTouchpadTouchEnd(object sender, ControllerInteractionEventArgs e) {
		...
		if(GameObject.Find("ColorHistoryMenu") != null) { 
			Colorhistory_RadialMenu menu = GameObject.Find("ColorHistoryMenu").GetComponent<Colorhistory_RadialMenu>();
			if (menu != null) {
				menu.AddButton(new Colorhistory_RadialMenu.RadialMenuButton(), cubeColor);
			} else {
